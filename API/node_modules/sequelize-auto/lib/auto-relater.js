...
class AutoRelater {
    ...
    addRelation(table, fkFieldName, spec, fkFields) {
        ...
        const alias = this.getAlias(fkFieldName, spec.foreignSources.target_table);
        ...
        if (spec.isPrimaryKey) {
            ...
            if (otherKey) {
                ...
                const otherProp = this.getAlias(otherKey.source_column, otherKey.foreignSources.target_table);
    ...
    getAlias(fkFieldName, modelName) {
